            ...
            this.submit(function(e) {
              function s() {
                ...
                return i.settings.submitHandler
                  ? (i.submitButton
                    && (s = t("<input type='hidden'/>").attr("name", i.submitButton.name).val(t(i.submitButton).val())
              ...
              return i.settings.debug && e.preventDefault(),
                i.cancelSubmit
                  ? (i.cancelSubmit = !1, s())
                  : i.form()
                  ? i.pendingRequest ? (i.formSubmitted = !0, !1) : s()
                  : (i.focusInvalid(), !1);
            })),
          i);
    },
    ...
    t.extend(t.validator, {
      defaults: {
        ...
        onkeyup: function(t, e) {
          (9 !== e.which || "" !== this.elementValue(t)) && (t.name in this.submitted || t === this.lastElement)
            && this.element(t);
        },
        onclick: function(t) {
      ...
      prototype: {
        init: function() {
          ...
          t.each(s, function(e, i) {
            ...
            t(this.currentForm).validateDelegate(
        ...
        focusInvalid: function() {
          if (this.settings.focusInvalid) {
            try {
              t(this.findLastActive() || this.errorList.length && this.errorList[0].element || []).filter(":visible")
        ...
        elements: function() {
          var e = this, i = {};
          return t(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, [disabled]").not(
        ...
        showLabel: function(e, i) {
          ...
          s.length
            ...
            : (s = t("<" + this.settings.errorElement + ">").attr("for", this.idOrName(e)).addClass(
