                    ...
                    <div class="page-content">
                        ...
                        <div class="row-iconbox">
                            <div class="container">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="themesflat-headings style-1 text-center clearfix">
                                            ...
                                            <p
                                                ...
                                                Are you interested in working with us? For more information on our services
                                                please contact us.</p>
                                        </div>
                                        <div class="themesflat-spacer clearfix" data-desktop="45" data-mobile="35"
                                            data-smobile="35"></div>
                                    </div><!-- /.col-md-12 -->
                                </div><!-- /.row -->
                                ...
                                <div class="row gutter-16">
                                    <div class="col-md-4">
                                        <div
                                            ...
                                            <div class="text-wrap">
                                                <h5 class="heading"><a href="#">{{ $config->phone }}</a></h5>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div
                                            ...
                                            <div class="text-wrap">
                                                <h5 class="heading"><a href="#">{{ $config->address }}</a></h5>
                                                <p class="sub-heading">(Visit By Appointments Only)</p>
                                            </div>
                                        </div><!-- /.themesflat-icon-box -->
                                    </div><!-- /.col -->
                                    <div class="col-md-4">
                                        ...
                                        <div
                                            ...
                                            <div class="text-wrap">
                                                <h5 class="heading"><a href="#">{{ $config->email }}</a></h5>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="themesflat-spacer clearfix" data-desktop="58" data-mobile="35"
                                            data-smobile="35"></div>
                                    </div><!-- /.col-md-12 -->
                                </div><!-- /.row -->
                            </div><!-- /.container -->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="themesflat-contact-form style-2 w100 clearfix">
                                            ...
                                            @endif
                                            <form id="contactForm" action="{{ route('frontend.contact.store') }}"
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12 text-end">
                                                        <button type="submit" class="btn btn-primary px-4 py-2">Send
                                                            Message</button>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <div class="container">
                                <div class="row align-items-stretch">
                                    <div class="col-md-4 d-flex">
                                        <div
                                            class="themesflat-contact-form style-2 w-100 h-100 d-flex flex-column justify-content-center">
                                            @if (session('success'))
                                            ...
                                            <form id="contactForm" action="{{ route('frontend.contact.store') }}"
                                                method="POST"
                                                class="p-4 border rounded shadow-sm bg-light flex-grow-1 d-flex flex-column justify-content-between">
                                                @csrf
                                                <div class="row g-3">
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <label for="topic"
                                                            class="form-label fw-semibold">Topic*</label>
                                                        <input type="text" id="topic" name="topic"
                                                            value="{{ old('topic') }}"
                                    ...
                                    <div class="col-md-8">
                                        <div class="h-100">
                                            <iframe src="{{ $config->map }}" width="100%" height="100%"
                                                style="border:0; min-height:550px;" allowfullscreen="" loading="lazy"
