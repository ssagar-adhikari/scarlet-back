...
<head>
    ...
    <!-- Colors -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/assets/css/colors/color1.css') }}"
        id="colors">
                    ...
                    <div id="site-header-inner" class="container">
                        <div class="wrap-inner clearfix">
                            <div id="site-logo" class="clearfix">
                                <div id="site-log-inner">
                                    <a href="{{ route('frontend.home') }}" rel="home" class="main-logo">
                                        <img src="{{ asset($config->logo) }}" alt="logo-small" width="186"
                                            height="39" data-retina="{{ asset($config->logo) }}" data-width="186"
                                            data-height="39">
                                    </a>
                                </div>
                            </div><!-- /#site-logo -->
                            ...
                            <nav id="main-nav" class="main-nav">
                                <ul id="menu-primary-menu" class="menu">
                                    <li
                                        class="menu-item {{ request()->routeIs('frontend.home') ? 'current-menu-item' : '' }}">
                                        <a href="{{ route('frontend.home') }}">HOME</a>
                                    </li>
                                    <li
                                        class="menu-item {{ request()->routeIs('frontend.portfolios') ? 'current-menu-item' : '' }}">
                                        <a href="{{ route('frontend.portfolios') }}">PORTFOLIO</a>
                                    </li>
                                    <li
                                        class="menu-item {{ request()->routeIs('frontend.about') ? 'current-menu-item' : '' }}">
                                        <a href="{{ route('frontend.about') }}">ABOUT US</a>
                                    </li>
                                    <li
                                        class="menu-item {{ request()->routeIs('frontend.services') ? 'current-menu-item' : '' }}">
                                        <a href="{{ route('frontend.services') }}">OUR SERVICES</a>
                                    </li>
                                    <li
                                        class="menu-item {{ request()->routeIs('frontend.blogs') ? 'current-menu-item' : '' }}">
                                        <a href="{{ route('frontend.blogs') }}">BLOG</a>
                                    </li>
                                    <li
                                        class="menu-item {{ request()->routeIs('frontend.gallery') ? 'current-menu-item' : '' }}">
                                        <a href="{{ route('frontend.gallery') }}">GALLERY</a>
                                    </li>
                                    <li
                                        class="menu-item {{ request()->routeIs('frontend.contact') ? 'current-menu-item' : '' }}">
                                        <a href="{{ route('frontend.contact') }}">CONTACT</a>
                                    </li>
                                </ul>
                            </nav>
